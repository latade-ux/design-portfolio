...
// Gradient helpers
const GRAD_INDIGO_PURPLE = {
    type: "GRADIENT_LINEAR",
    gradientStops: [
        { color: Object.assign(Object.assign({}, hex("#6366F1")), { a: 1 }), position: 0 },
        { color: Object.assign(Object.assign({}, hex("#A855F7")), { a: 1 }), position: 1 },
    ],
    gradientTransform: [[1, 0, 0], [0, 1, 0]],
};
const GRAD_BLUE_CYAN = {
    type: "GRADIENT_LINEAR",
    gradientStops: [
        { color: Object.assign(Object.assign({}, hex("#3B82F6")), { a: 1 }), position: 0 },
        { color: Object.assign(Object.assign({}, hex("#06B6D4")), { a: 1 }), position: 1 },
    ],
    gradientTransform: [[1, 0, 0], [0, 1, 0]],
};
const GRAD_EMERALD_TEAL = {
    type: "GRADIENT_LINEAR",
    gradientStops: [
        { color: Object.assign(Object.assign({}, hex("#10B981")), { a: 1 }), position: 0 },
        { color: Object.assign(Object.assign({}, hex("#14B8A6")), { a: 1 }), position: 1 },
    ],
    gradientTransform: [[1, 0, 0], [0, 1, 0]],
};
const GRAD_AMBER_ORANGE = {
    type: "GRADIENT_LINEAR",
    gradientStops: [
        { color: Object.assign(Object.assign({}, hex("#F59E0B")), { a: 1 }), position: 0 },
        { color: Object.assign(Object.assign({}, hex("#F97316")), { a: 1 }), position: 1 },
    ],
    gradientTransform: [[1, 0, 0], [0, 1, 0]],
};
const GRAD_ROSE_PINK = {
    type: "GRADIENT_LINEAR",
    gradientStops: [
        { color: Object.assign(Object.assign({}, hex("#F43F5E")), { a: 1 }), position: 0 },
        { color: Object.assign(Object.assign({}, hex("#EC4899")), { a: 1 }), position: 1 },
    ],
    gradientTransform: [[1, 0, 0], [0, 1, 0]],
};
function loadFonts() {
...
function createText(content, size, color, style = "Regular", lineHeight) {
...
function createRect(w, h, fills, radius = 0) {
...
function autoFrame(name, direction, width, height) {
    ...
    if (height)
        f.resize(f.width, height);
    return f;
}
/** Wrapper: full-width section frame at 1440 wide */
function sectionFrame(name, height, bgColor, bgOpacity) {
    const f = figma.createFrame();
    f.name = name;
    ...
    f.clipsContent = true;
    if (bgColor) {
        f.fills = solid(bgColor, bgOpacity !== null && bgOpacity !== void 0 ? bgOpacity : 1);
    }
    else {
        f.fills = [];
    }
...
function pill(text, fg = T.mutedFg, bg = T.surface, border) {
...
function buildHero() {
    ...
    // Subparagraph
    const sub = createText("Senior Product Designer with 7+ years shaping enterprise SaaS,\nAI workflows, and data-rich platforms. I partner with product and\nengineering teams to deliver measurable outcomes.", 18, T.muted, "Regular", 28);
...
function buildProjects() {
    ...
    // Header
    const header = sectionHeader("SELECTED WORK", "Projects that moved metrics", "A selection of enterprise-scale design work spanning AI systems, data platforms, and complex workflows.");
...
function buildProcess() {
    ...
    inner.itemSpacing = 48;
    const header = sectionHeader("HOW I WORK", "Design process", "A structured yet flexible approach to solving complex design challenges, refined through years of shipping enterprise products.");
    inner.appendChild(header);
    const steps = [
        {
            num: "01",
...
function buildExperience() {
    ...
    inner.itemSpacing = 48;
    const header = sectionHeader("EXPERIENCE", "Where I've made impact");
    inner.appendChild(header);
    const roles = [
        {
...
function buildAbout() {
    ...
    const bio1 = createText("I'm a Senior Product Designer based in the United Kingdom, passionate about making complex systems feel intuitive. With over 7 years of experience, I've worked across enterprise SaaS, fintech, and AI-driven platforms.", 16, T.muted, "Regular", 26);
    bio1.resize(460, bio1.height);
    bio1.textAutoResize = "HEIGHT";
    leftCol.appendChild(bio1);
    const bio2 = createText("My work sits at the intersection of design, data, and AI. I believe the best products are built when designers deeply understand the technology they're working with and the people they're designing for.", 16, T.muted, "Regular", 26);
    bio2.resize(460, bio2.height);
    bio2.textAutoResize = "HEIGHT";
    leftCol.appendChild(bio2);
    const bio3 = createText("When I'm not designing, you'll find me exploring new AI tools, contributing to open-source design resources, or mentoring junior designers making their way into the industry.", 16, T.muted, "Regular", 26);
    ...
    const quoteText = createText("AI doesn't replace design thinking \u2014 it raises the bar for what thoughtful design can achieve.", 16, T.muted, "Regular", 26);
...
function buildTestimonials() {
    ...
    inner.itemSpacing = 48;
    const header = sectionHeader("TESTIMONIALS", "What collaborators say");
    inner.appendChild(header);
    const testimonials = [
        {
        ...
        avatar.fills = [
            {
                type: "GRADIENT_LINEAR",
                gradientStops: [
                    { color: Object.assign(Object.assign({}, t.gradientStart), { a: 1 }), position: 0 },
                    { color: Object.assign(Object.assign({}, t.gradientEnd), { a: 1 }), position: 1 },
                ],
                gradientTransform: [[1, 0, 0], [0, 1, 0]],
            },
        ];
...
function buildContact() {
    ...
    // Description
    const desc = createText("I'm always open to discussing new opportunities, interesting projects,\nor ways to make complex products better for everyone.", 16, T.muted, "Regular", 26);
