      ...
      >
        ...
        >
          <a
            ...
            className="group inline-flex items-center gap-2 px-8 py-3.5 rounded-lg bg-foreground text-background font-medium text-sm hover:opacity-90 transition-opacity"
          >
            <svg
              className="w-4 h-4"
              fill="none"
